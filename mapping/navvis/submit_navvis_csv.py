        ...
        for row in csv_reader:
            ...
            for i in range(10):
                try:
                    ...
                    f"Warning: ValueError when processing line {csv_reader.line_num}"
                    return
...
def append_data_with_image_path(data_list: list[dict], images_directory: str) -> list[dict]:
    ...
    for data in data_list:
        image_path = os.path.join(images_directory, data["file_name"].strip())
...
if __name__ == '__main__':
    ...
    input_trajectory_file = r"<path-to-trajectory-csv-file>"
